...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  platzkontingente: { einrichtung: "Bitte eine Einrichtung auswählen.", kita_jahr: "Bitte das Kita-Jahr eingeben (z. B. 2026/27).", betreuungsform: "Bitte die Betreuungsform auswählen.", plaetze_gesamt: "Bitte die Gesamtzahl der Plätze eingeben." },
  kinder: { vorname: "Bitte den Vornamen des Kindes eingeben.", nachname: "Bitte den Nachnamen des Kindes eingeben.", geburtsdatum: "Bitte das Geburtsdatum eingeben.", strasse: "Bitte die Straße der Wohnadresse eingeben.", hausnummer: "Bitte die Hausnummer eingeben.", plz: "Bitte die Postleitzahl eingeben.", ort: "Bitte den Wohnort eingeben." },
  anfragen: { kind: "Bitte das Kind auswählen.", eltern_vorname: "Bitte den Vornamen des Elternteils eingeben.", eltern_nachname: "Bitte den Nachnamen des Elternteils eingeben.", eltern_email: "Bitte die E-Mail-Adresse des Elternteils eingeben.", einrichtung: "Bitte die gewünschte Einrichtung auswählen.", betreuungsform: "Bitte die Betreuungsform auswählen.", gewuenschter_start: "Bitte das gewünschte Startdatum wählen.", betreuungsumfang: "Bitte den Betreuungsumfang auswählen." },
  // </custom:messages>
};
