...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Kita-Platzvergabe Forchheim",
    "apps": {
      "einrichtungen": {
        "name": "Einrichtungen",
        "app_id": "6aa95d9522cd16bf318fc896",
        "fields": {
          "name": "Name der Einrichtung",
          "traegerart": "Trägerart",
          "beschreibung": "Beschreibung",
          "foto": "Foto der Einrichtung",
          "strasse": "Straße",
        ...
        "lookups": {
          ...
          "betreuungsformen": {
            "krippe": "Krippe (unter 3 Jahre)",
            "kindergarten": "Kindergarten (3–6 Jahre)",
            "hort": "Hort"
          }
        }
      },
      "mitarbeiter": {
        "name": "Mitarbeiter",
        "app_id": "6aa95d9de38462db33f2ed31",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
          "rolle": "Rolle",
        ...
        "lookups": {
          "rolle": {
            "traeger": "Träger (Stadtverwaltung)",
            "einrichtungsleitung": "Einrichtungsleitung"
          }
        }
      },
      "platzkontingente": {
        "name": "Platzkontingente",
        "app_id": "6aa95d9ea2bf16980067e647",
        "fields": {
          "einrichtung": "Einrichtung",
          "kita_jahr": "Kita-Jahr",
          "betreuungsform": "Betreuungsform",
          "plaetze_gesamt": "Plätze gesamt"
        },
        "lookups": {
          "betreuungsform": {
            "kindergarten": "Kindergarten (3–6 Jahre)",
      ...
      "kinder": {
        "name": "Kinder",
        "app_id": "6aa95d9f705c3b105a495885",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
          ...
          "plz": "Postleitzahl",
          "ort": "Ort",
          "besonderheiten": "Besonderheiten (Allergien, Förderbedarf)",
          "geschwisterkind": "Geschwisterkind bereits in einer Einrichtung"
        },
        "lookups": {
          "geschlecht": {
            "weiblich": "Weiblich",
      ...
      "anfragen": {
        ...
        "fields": {
          "kind": "Kind",
          "eltern_vorname": "Vorname des Elternteils",
          "eltern_nachname": "Nachname des Elternteils",
          "eltern_email": "E-Mail des Elternteils",
          "eltern_telefon": "Telefon des Elternteils",
          "einrichtung": "Gewünschte Einrichtung",
          "zweitwunsch_einrichtung": "Zweitwunsch Einrichtung",
          "betreuungsform": "Betreuungsform",
          "gewuenschter_start": "Gewünschter Betreuungsstart",
          "betreuungsumfang": "Betreuungsumfang",
          "berufstaetig": "Beide Elternteile berufstätig",
          "anfragenummer": "Anfragenummer",
          "eingegangen_am": "Eingegangen am",
          "status": "Status",
          "wartelistenplatz": "Wartelistenplatz",
          "entscheidung_am": "Entscheidung am",
  ...
  "en": {
    ...
    "apps": {
      ...
      "mitarbeiter": {
        ...
        "lookups": {
          "rolle": {
            "traeger": "Provider (City Administration)",
            "einrichtungsleitung": "Facility Director"
          }
        }
      },
      "platzkontingente": {
      ...
      "anfragen": {
        ...
        "fields": {
          ...
          "berufstaetig": "Both Parents Employed",
