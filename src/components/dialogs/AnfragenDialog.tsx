  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'eltern_email': (
      <div key="eltern_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. thomas.schmidt@mail.de"
    ...
    'einrichtung': (
      <div key="einrichtung" className="space-y-1.5">
        ...
        <Combobox
          id="einrichtung"
          placeholder="1. Wunsch – Welche Einrichtung?"
    ...
    'zweitwunsch_einrichtung': (
      <div key="zweitwunsch_einrichtung" className="space-y-1.5">
        ...
        <Combobox
          ...
          placeholder="2. Wunsch – Alternative?"
          items={einrichtungenListAll.map(r => ({
            id: r.record_id,
            label: String(r.fields.name ?? r.record_id),
          }))}
    ...
    'eingegangen_am': (
      <div key="eingegangen_am" className="space-y-1.5">
        ...
        <DatePicker
          id="eingegangen_am"
          placeholder="Wann ist die Anfrage eingegangen?"
          mode="date"
    ...
    'status': (
      <div key="status" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="status" className="max-sm:h-11"><SelectValue placeholder="Status auswählen" /></SelectTrigger>
          <SelectContent>
    ...
    'entscheidung_am': (
      <div key="entscheidung_am" className="space-y-1.5">
        ...
        <DatePicker
          id="entscheidung_am"
          placeholder="Wann wurde die Entscheidung getroffen?"
          mode="date"
    ...
    'interne_notizen': (
      <div key="interne_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="interne_notizen"
          placeholder="Besonderheiten, Rückfragen, Vermerke"
