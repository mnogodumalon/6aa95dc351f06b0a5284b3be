...
### `einrichtungen` — Einrichtungen (type `Einrichtungen`, one record: `EinrichtungenEntry`)
Display fields: `name`
- `name` · text · Name der Einrichtung · required! · maxLength 4000
- `traegerart` · lookup · Trägerart · required! · options: kirchlich | frei | staedtisch
- `beschreibung` · textarea · Beschreibung
- `foto` · file · Foto der Einrichtung · read-only
...
- `telefon` · tel · Telefon
- `email` · email · E-Mail
- `betreuungsformen` · multilookup · Betreuungsformen · required! · options: krippe | kindergarten | hort
- `oeffnungszeiten` · textarea · Öffnungszeiten
Input shapes: choice `traegerart` (ChoiceGroup)
...
- `rolle` · lookup · Rolle · required! · options: traeger | einrichtungsleitung
- `einrichtung` · record · Einrichtung · → `einrichtungen`
- `email_ma` · email · E-Mail · required!
- `telefon_ma` · tel · Telefon
Input shapes: choice `rolle` (ChoiceGroup)

### `platzkontingente` — Platzkontingente (type `Platzkontingente`, one record: `PlatzkontingenteEntry`)
Display fields: `kita_jahr`
- `einrichtung` · record · Einrichtung · required! · → `einrichtungen`
- `kita_jahr` · text · Kita-Jahr · required! · maxLength 4000
- `betreuungsform` · lookup · Betreuungsform · required! · options: kindergarten | hort | krippe
- `plaetze_gesamt` · number · Plätze gesamt · required! · currency
Input shapes: choice `betreuungsform` (ChoiceGroup)

### `kinder` — Kinder (type `Kinder`, one record: `KinderEntry`)
Display fields: `vorname`, `nachname`
- `vorname` · text · Vorname · required! · maxLength 4000
- `nachname` · text · Nachname · required! · maxLength 4000
- `geburtsdatum` · date · Geburtsdatum · required!
- `geschlecht` · lookup · Geschlecht · options: weiblich | maennlich | divers
- `strasse` · text · Straße · required! · maxLength 4000
- `hausnummer` · text · Hausnummer · required! · maxLength 4000
- `plz` · text · Postleitzahl · required! · maxLength 4000
- `ort` · text · Ort · required! · maxLength 4000
- `besonderheiten` · textarea · Besonderheiten (Allergien, Förderbedarf)
- `geschwisterkind` · bool · Geschwisterkind bereits in einer Einrichtung
Input shapes: choice `geschlecht` (ChoiceGroup)

### `anfragen` — Anfragen (type `Anfragen`, one record: `AnfragenEntry`)
Display fields: `eltern_vorname`
- `kind` · record · Kind · required! · → `kinder`
- `eltern_vorname` · text · Vorname des Elternteils · required! · maxLength 4000
- `eltern_nachname` · text · Nachname des Elternteils · required! · maxLength 4000
- `eltern_email` · email · E-Mail des Elternteils · required!
- `eltern_telefon` · tel · Telefon des Elternteils
- `einrichtung` · record · Gewünschte Einrichtung · required! · → `einrichtungen`
- `zweitwunsch_einrichtung` · record · Zweitwunsch Einrichtung · → `einrichtungen`
- `betreuungsform` · lookup · Betreuungsform · required! · options: krippe | kindergarten | hort
- `gewuenschter_start` · date · Gewünschter Betreuungsstart · required!
- `betreuungsumfang` · lookup · Betreuungsumfang · required! · options: halbtags | ganztags | verlaengert
- `berufstaetig` · bool · Beide Elternteile berufstätig
- `anfragenummer` · text · Anfragenummer · maxLength 4000
- `eingegangen_am` · date · Eingegangen am
- `status` · lookup · Status · options: eingegangen | in_pruefung | warteliste | zugesagt | abgelehnt | zurueckgezogen
- `wartelistenplatz` · number · Wartelistenplatz
- `entscheidung_am` · date · Entscheidung am
- `ablehnungsgrund` · textarea · Ablehnungsgrund
- `interne_notizen` · textarea · Interne Notizen
Input shapes: choice `betreuungsform` (ChoiceGroup); choice `betreuungsumfang` (ChoiceGroup); choice `status` (ChoiceGroup)
